  ...
  <p align="center"><img width="150" src="https://github.com/leapar/g3nd/blob/master/data/images/g3n_logo.png" alt="G3N Banner"/></p>
  <p align="center">
    <a href="https://godoc.org/github.com/leapar/engine"><img src="https://godoc.org/github.com/leapar/engine?status.svg" alt="Godoc"></img></a>
    <a href="https://goreportcard.com/report/github.com/leapar/engine"><img src="https://goreportcard.com/badge/github.com/leapar/engine"  alt="Go Report Card"/></a>
  </p>
...
It can be used to write cross-platform Go applications that show rich and dynamic 3D representations - not just games. A basic integrated GUI framework is provided, and 3D spatial audio is supported through [OpenAL](https://www.openal.org/).
  ...
  ### **To see G3N in action try the [G3N demo](https://github.com/leapar/g3nd) or the [Gokoban](https://github.com/danaugrs/gokoban) award winning game.**
...
Install the development files of OpenAL and Vorbis using [Homebrew](https://brew.sh/):
  ...
  `go get -u github.com/leapar/engine/...`
  ...
  * Support for HiDPI displays
  ...
  <p align="center">
    <img style="float: right;" src="https://github.com/leapar/g3n.github.io/raw/master/img/g3n_banner_small.png" alt="G3N Banner"/>
  </p>

  ## Hello G3N

  The code below is a basic "hello world" application 
  ([hellog3n](https://github.com/leapar/demos/tree/master/hellog3n))
  that shows a blue torus.
  You can download and install `hellog3n` via:
    
    go get -u github.com/leapar/demos/hellog3n

  For more complex demos please see the [G3N demo program](https://github.com/leapar/g3nd).

  ```Go
  package main

  import (
      "github.com/leapar/engine/util/application"
  ...
  <p align="center">
    <img style="float: right;" src="https://github.com/leapar/demos/blob/master/hellog3n/screenshot.png" alt="hellog3n Screenshot"/>
  </p>

  ## Documentation

  The complete engine API reference can be found here: [![GoDoc](https://godoc.org/github.com/leapar/engine?status.svg)](https://godoc.org/github.com/leapar/engine).

  There is also the beginning of a Getting Started Guide, and a newly created list of Guides and Tutorials:

  * [Getting Started](https://github.com/leapar/engine/wiki/Getting-Started-(WIP))
  * [Guides and Tutorials](https://github.com/leapar/engine/wiki/Guides-and-Tutorials)

  Along with those, a good way to learn how to use the engine is to see the source code of [G3ND - the G3N demo](https://github.com/leapar/g3nd).
